...
class UserIdentificationData(Main):
    ...
    id_type = models.ForeignKey(UserIdentificationType, on_delete=models.SET_NULL, blank=True, null=True)
    id_number = models.CharField(blank=True, null=True, max_length=255)
    image = models.ImageField(upload_to='account/user_identification_data/image', blank=True, null=True)
