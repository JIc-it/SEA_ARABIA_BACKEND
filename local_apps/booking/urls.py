...
urlpatterns = [
    ...
    path('vendor-booking-count/', VendorBookingCardCount.as_view(), name='booking-cancellation'),

    # Admin Individual Booking View For Admin CMS
    path('admin-booking-view/<uuid:pk>', AdminIndividualBookingView.as_view(), name='booking-view-admin-cms'),
]
