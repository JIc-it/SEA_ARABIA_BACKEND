...
urlpatterns = [
    ...
    path("company-create/", CompanyCreate.as_view(),name="companydetails-create"),
    path("company-view/<uuid:pk>", CompanyView.as_view(),name="companydetails-view"),
    path("company-update/<uuid:pk>",CompanyUpdate.as_view(),name="companydetails-update"),
    ...
    path("negotation-create/", NegotiationCreate.as_view(),name="negotation-create"),
    path("negotation-view/<uuid:pk>", NegotiationView.as_view(), name="negotation-view"),
    path("negotation-update/<uuid:pk>",NegotiationUpdate.as_view(),name="negotation-update",),
    # MOUorCharter urls
