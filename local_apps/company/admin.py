...
class CompanyAdmin(admin.ModelAdmin):
    inlines = [MiscellaneousAdmin,SiteVisitAdmin,ProposalAdmin,NegotiationAdmin,MOUorCharterAdmin]
    list_display = ["name",'user',"registration_number",'created_by',"is_onboard","is_active"]
